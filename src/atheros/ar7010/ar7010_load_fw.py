...
AR7010_FIRMWARE_TEXT_BASE = 0x906000
...
parser = argparse.ArgumentParser(description='Load AR7010 firmware')
...
if (dev == None):
    print("No AR7010 BootROM device found, wrong VID/PID?")
    exit()
...
# Boot
dev.ctrl_transfer(USB_VENDOR_REQUEST_OUT, USB_FIRMWARE_DOWNLOAD_COMPLETE, AR7010_FIRMWARE_TEXT_BASE >> 8, 0)
